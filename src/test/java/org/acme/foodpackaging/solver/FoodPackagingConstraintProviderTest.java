...
class FoodPackagingConstraintProviderTest {
    ...
    ConstraintVerifier<FoodPackagingConstraintProvider,PackagingSchedule> constraintVerifier = ConstraintVerifier.build(
            new FoodPackagingConstraintProvider(), PackagingSchedule.class, Job.class, Line.class);
